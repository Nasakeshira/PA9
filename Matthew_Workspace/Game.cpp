...
void Game::run()
{
	...
	// Loaded Sounds
	SoundBuffer Whitebuffer[7];#include "Game.h"
using namespace sf;
...
void Game::run()
{
	...
	// Loaded Sounds
	SoundBuffer Whitebuffer[7], WhitebufferOctave;
	//A
	...
	WhitebufferOctave.loadFromFile("1g - white 1.wav");
	
	WhitesoundOctave.setBuffer(WhitebufferOctave);

	WhitesoundOctave.setPitch(2.f);
...
// Get sound to play!
void Game::handleInput(sf::Sound Whitesound[], sf::Sound Blacksound[], sf::Sound WhitesoundOctave)
{
	Piano::loadSound();
